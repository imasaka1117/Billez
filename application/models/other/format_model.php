...
class Format_model extends CI_Model {
	...
	public function normal_bill() {
		return array(Table_1::$bill . '.' . Field_1::$billez_code,
					 ...
					 'CONCAT(' . Table_1::$bill . '.' . Field_1::$trader_code . ',' . Table_1::$bill . '.' . Field_1::$bill_kind_code . ',' . Field_1::$identify_data . ') AS ' . Field_3::$subscribe_code,
