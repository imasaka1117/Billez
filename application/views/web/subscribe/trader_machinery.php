...
<body>
	<div id="content_div">
		...
		<table cellpadding="10">
			...
			<tr>
				<td>*要更改的代收機構 : </td>	
				<td><select id="machinery" class="required"><option value="">請選擇</option></select></td>
				<td>*要更改的代收機構合約 : </td>	
				<td><select id="machinery_contract" class="required"><option value="">請選擇</option></select></td>	
