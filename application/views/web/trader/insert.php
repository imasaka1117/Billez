...
<body>
	<div id="content_div">
		...
		<table cellpadding="10">
			...
			<tr>
				<td>*業者等級 :</td>
				<td><select id="level" class="required"></select></td>
			</tr>
			<tr>
				<td>*統一編號 :</td>
			...
			<tr>
				<td>*聯絡地址 :</td>
				<td><select id="city" class="required" ></select>
					<select id="district" class="required"><option value="">請選擇 鎮/區</option></select>
			...
			<tr>
				<td>*姓名 : </td>
				<td><input type="text" id="main_contact_person_name" size="20" class="required" /></td>
			</tr>
			<tr>
				<td>*電話 : </td>
				<td><input type="text" id="main_contact_person_phone" size="20" maxlength="10" class="required digits" /></td>
			</tr>
			<tr>
				<td>*E-mail : </td>
				<td><input type="text" id="main_contact_person_email" size="40" class="required email" /></td>
			</tr>
			<tr>
				<th>次要聯絡人</th>
			</tr>
			<tr>
				<td>*姓名 : </td>
				<td><input type="text" id="second_contact_person_name" size="20" class="required" /></td>
			</tr>
			<tr>
				<td>*電話 : </td>
				<td><input type="text" id="second_contact_person_phone" size="20" maxlength="10" class="required digits" /></td>
			</tr>
			<tr>
				<td>*E-mail : </td>
				<td><input type="text" id="second_contact_person_email" size="40" class="required email" /></td>
			</tr>
			<tr>
				<td>備註 :</td>
